  ...
  return (
    <div className="single-page">
      ...
      <div className='btnWrap'>
        ...
        <Link to={`/`}>
          <button className='single-pageBtn' onClick={() => props.setSelectedRecipe('')}>Back</button>
        </Link>
      </div>
      ...
      <div className='singlecard'>
        ...
        <div className='mealtypewrap'>
          <p> Meal type:</p>
          <div className='mealtype'> {props.recipe.mealType.map(e => <li>{e}</li>)} </div>
        </div>



        <p>Is Vegan: {props.recipe.isVegan.toString(e => <li>{e}</li>)}</p>
        <p>is Vegetarian: {props.recipe.isVegetarian.toString(e => <li>{e}</li>)}</p>
